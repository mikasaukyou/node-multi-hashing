...
NAN_METHOD(lyra2revc0ban) {
    ...
    lyra2revc0ban_hash(input, output);
...
NAN_MODULE_INIT(init) {
	...
	Nan::Set(target, Nan::New("lyra2revc0ban").ToLocalChecked(), Nan::GetFunction(Nan::New<FunctionTemplate>(lyra2revc0ban)).ToLocalChecked());
